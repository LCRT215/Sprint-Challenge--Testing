...
The purpose of test driven development is a way write to new code only if a automated test failed and helps to avoids duplicating code. It makes code cleaner and easier to correct.
